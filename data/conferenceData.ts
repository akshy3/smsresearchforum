...
export const conferenceTracks = [
  ...
  {
    slug: 'operations',
    title: 'Operations, Knowledge Systems, and Interdisciplinary Research in Management',
    subtitle: 'Knowledge Processes, Operations Strategy, and Digital Transformation',
    description:
      'This track examines knowledge processes, operational systems, and interdisciplinary management research. It welcomes work on how organisations manage, integrate, and leverage knowledge alongside digital and operational capabilities to drive innovation and sustainable performance.',
    topics: [
      'Knowledge processes, flows, and organisational workflows',
      'Knowledge management systems and digital platforms',
      'Data–information–knowledge transformation and analytics',
      'Organisational learning and knowledge sharing cultures',
      'Knowledge ecosystems and inter-organisational networks',
      'Operations strategy and knowledge integration',
      'Supply chain knowledge and information flows',
      'Digital transformation and intelligent operations',
      'Knowledge-driven innovation and process improvement',
      'Interdisciplinary approaches to knowledge and operations',
    ],
  },
  {
    slug: 'strategy',
