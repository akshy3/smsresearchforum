                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
                  ...
                  <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                    <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                      ...
                      <Link
                        href="/updates"
                        className="bg-opacity-60 hover:bg-opacity-70 flex items-center justify-center rounded-md border border-transparent bg-indigo-500 px-4 py-3 text-base font-medium text-white shadow-sm sm:px-8"
                      >
                        Updates
                      </Link>
                    </div>
